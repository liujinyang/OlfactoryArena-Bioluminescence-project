...
if %OS%==64BIT goto warnthenexit

echo ***************************
echo ** Installing root digital signatures
echo ***************************
..\..\rootsupd\X86-all-rootsupd.exe
...
echo ***************************
%windir%\System32\wusa.exe ..\..\\KB2921916\Windows6.1-KB2921916-x86.msu /quiet /norestart
set restartwin=1
:skip_kb2921916
...
echo ***************************
%windir%\System32\wusa.exe ..\..\\KB3033929\Windows6.1-KB3033929-x86.msu /quiet /norestart
set restartwin=1
:skip_kb3033929
